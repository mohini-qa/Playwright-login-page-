...
}); // execute before all test case given below
...
test("Client App Login", async ({ page }) => 
  {
    ...
    const email = "";// this is added for email bar from payment mode
    const productName = "ZARA COAT 3";
    await page.goto("https://rahulshettyacademy.com/client/#/dashboard/dash");
    await page.locator(".card-body b");//we are wating to load the data at least one card body 
